...
```
Notice that that `n` is negative, implying that studies with larger sample 
sizes are more consistent (i.e., less heterogeneity).
...
that the effect sizes are nested within. This accomodates dependent 
effect sizes.
