...
is because I am preparing to hopefully be a professor. To this end, I am planning 
...
Options 3-4 will be ongoing for undergraduate students. 
Option 2 will also result in being an author on the software paper 
for **blsmeta** (written once students contribute). 
For each option, students will learn valuable skills for industry 
(e.g., data science) and academia (pursing a PhD).
