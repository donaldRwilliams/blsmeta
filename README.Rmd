...
is on the log-scale, which is far from intuitive. To make sense of the 
scale model, it is possible to predict between-study heterogeneity at particular 
values of the moderator, that is,
...
heterogeneity in small studies, but it goes to practically zero as the 
