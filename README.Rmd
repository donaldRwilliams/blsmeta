...
manuscript). Option 2 will also result in being an author on the 
software paper for **blsmeta** (written once students contribute). 
For each option, students will learn valuable skills for industry (e.g., data science) and academia (pursing a PhD).
...
working with underrepresented students (BIPOC, first-generation, students from developing countries, etc.) takes precedence. 
