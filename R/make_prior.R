#' @title Make Prior Distributions
#' 
#' @description Make user-defined prior distributions. This
#' is useful for ensuring the priors are correctly specified,
#' and also sampling from the priors. 
#'  
#' @inheritParams blsmeta
#' 
#' @return A character string with the priors.
#' 
#' @export
#' 
#' @examples 
...
make_prior <- function(yi, vi, 
  ...
  returned_object <- list(priors = priors)
  class(returned_object) <- c("blsmeta", "make_prior")
